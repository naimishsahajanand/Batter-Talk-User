// ignore_for_file: prefer_const_constructors, prefer_final_fields, unnecessary_brace_in_string_interps, avoid_print, non_constant_identifier_names
...
class _ProfessionalDetailPageState extends State<ProfessionalDetailPage> {
  ...
  Setdata() {
    _registerController.dropdownValue = loadprofiledata!.location.toString();
    _registerController.prodropdownValue =
        loadprofiledata!.professtion.toString();
  }
        ...
        children: [
          ...
          Container(
            ...
            child: DropdownMenu<String>(
              initialSelection: _registerController.dropdownValue,
              width: Get.width - 30,
              enabled: false,
              ...
              dropdownMenuEntries:
                  locationlist.map<DropdownMenuEntry<String>>((String value) {
          ...
          Container(
            ...
            child: DropdownMenu<String>(
              initialSelection: _registerController.prodropdownValue,
              width: Get.width - 30,
              enabled: false,
              onSelected: (String? value) {
                setState(() {
              ...
              dropdownMenuEntries:
                  proffesionlist.map<DropdownMenuEntry<String>>((String value) {
                return DropdownMenuEntry<String>(value: value, label: value);
              }).toList(),
            ),
          ),
